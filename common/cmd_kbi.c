...
#define HW_VERSION_ADC_VALUE_V14         0x24a
#define HW_VERSION_UNKNOW                0x00
#define HW_VERSION_V12                   0x12
#define HW_VERSION_V14                   0x13
...
static int get_hw_version(void)
{
	...
	} else if ((val >= HW_VERSION_ADC_VALUE_V14 - HW_VERSION_ADV_VALUE_TOLERANCE) && (val <= HW_VERSION_ADC_VALUE_V14 + HW_VERSION_ADV_VALUE_TOLERANCE)) {
		hw_ver = HW_VERSION_V14;
	} else {
