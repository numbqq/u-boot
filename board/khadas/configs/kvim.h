...
#define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "upgrade_check="\
            ...
            "\0"\
    "storeargs="\
            "setenv bootargs ${initargs} logo=${display_layer},loaded,${fb_addr},${outputmode} maxcpus=${maxcpus} vout=${outputmode},enable hdmimode=${hdmimode} cvbsmode=${cvbsmode} hdmitx=${cecconfig} cvbsdrv=${cvbs_drv} jtag=${jtag}; "\
            "run cmdline_keys;"\
            "\0"\
        "switch_bootmode="\
            "get_rebootmode;"\
...
#define CONFIG_PREBOOT  \
            ...
            "run vim_check;" \
            "run switch_bootmode;"
#define CONFIG_BOOTCOMMAND "cfgload;ext4load mmc 1:5 1080000 zImage;ext4load mmc 1:5 10000000 uInitrd;ext4load mmc 1:5 20000000 dtb.img;booti 1080000 10000000 20000000;run update;"
