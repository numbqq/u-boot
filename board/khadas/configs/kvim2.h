...
#define CONFIG_PREBOOT  \
			...
			"run upgrade_key;" \
			"run vim2_check;"
#define CONFIG_BOOTCOMMAND "cfgload;ext4load mmc 1:5 1080000 uImage;ext4load mmc 1:5 10000000 uInitrd;ext4load mmc 1:5 20000000 kvim2.dtb;bootm 1080000 10000000 20000000"
